...
+-----------------------------+----------------+---------+---------------+----------------------------------------+
| CAN0_MaxAllowedCurrent      | 0x130          | 8       | TX            | Maximum allowed current                |
+-----------------------------+----------------+---------+---------------+----------------------------------------+
...
+-----------------------------+----------------+---------+---------------+----------------------------------------+
| CAN0_MovMeanPower_0         | 0x1D0          | 8       | TX            | Moving mean power 0                    |
+-----------------------------+----------------+---------+---------------+----------------------------------------+
| CAN0_MovMeanPower_1         | 0x1D1          | 8       | TX            | Moving mean power 1                    |
+-----------------------------+----------------+---------+---------------+----------------------------------------+
| CAN0_MovMeanPower_2         | 0x1D2          | 8       | TX            | Moving mean power 2                    |
+-----------------------------+----------------+---------+---------------+----------------------------------------+
| CAN0_MovMeanCurrent_0       | 0x1E0          | 8       | TX            | Moving mean current 0                  |
+-----------------------------+----------------+---------+---------------+----------------------------------------+
| CAN0_MovMeanCurrent_1       | 0x1E1          | 8       | TX            | Moving mean current 1                  |
+-----------------------------+----------------+---------+---------------+----------------------------------------+
| CAN0_MovMeanCurrent_2       | 0x1E2          | 8       | TX            | Moving mean current 2                  |
+-----------------------------+----------------+---------+---------------+----------------------------------------+
...
The signals of the messages ``CAN0_MSG_SystemState_0`` , ``CAN0_MSG_SystemState_1`` and ``CAN0_MSG_SystemState_2`` display information about the system status
...
The various error signals ``CAN0_SIG_GSx_error_xxxx`` give information about limit violations and internal errors. In general, a value of 0 indicates 
no error and value of 1 displays an error. ``CAN0_SIG_GS1_current_sensor`` is 1 if no current sensor is detected and otherwise 0. The signal 
``CAN0_SIG_GS1_balancing_active`` is a simple flag to show if balancing is ON (1) or OFF (0). 
...
+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+
| **Message: CAN0_MSG_MaxAllowedCurrent**  | **Message ID: 0x130**        | **DLC: 8**     |             |            |            |            |          |               |
+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+
| **Signal name**                          | **Start bit**                | **Bit length** | **Min**     | **Max**    | **Factor** | **Offset** | **Unit** | **Byteorder** |
+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+
| CAN0_SIG_MaxChargeCurrent                | 0                            | 16             | 0.0         | 6553.5     | 0.1        | 0.0        | A        | Intel         |
+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+
| CAN0_SIG_MaxChargeCurrent_Peak           | 16                           | 16             | 0.0         | 6553.5     | 0.1        | 0.0        | A        | Intel         |
+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+
| CAN0_SIG_MaxDischargeCurrent             | 32                           | 16             | 0.0         | 6553.5     | 0.1        | 0.0        | A        | Intel         |
+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+
| CAN0_SIG_MaxDischargeCurrent_Peak        | 48                           | 16             | 0.0         | 6553.5     | 0.1        | 0.0        | A        | Intel         |
+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+

The current capability of the battery system is indicated by the signals of the previous table. For both discharge and charge directions, two values are 
stated, one for the continuous current capability and one for the peak current capability. Currently, the peak value is simply the same as the continuous value.
The resolution of the values is 0.1A, which should be of sufficient granularity for most applications. It is a tradeoff that enables a range up to 6553.5A 
...
+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+
| **Message: CAN0_MovMeanPower_0**         | **Message ID: 0x1D0**        | **DLC: 8**     |             |            |            |            |          |               |
+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+
| **Signal name**                          | **Start bit**                | **Bit length** | **Min**     | **Max**    | **Factor** | **Offset** | **Unit** | **Byteorder** |
+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+
| CAN0_SIG_MovMean_Power_1s                | 0                            | 32             | -2500000    | 4292467295 | 1.0        | -2500000   | W        | Intel         |
+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+
| CAN0_SIG_MovMean_Power_5s                | 32                           | 32             | -2500000    | 4292467295 | 1.0        | -2500000   | W        | Intel         |
+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+

+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+
| **Message: CAN0_MovMeanPower_1**         | **Message ID: 0x1D1**        | **DLC: 8**     |             |            |            |            |          |               |
+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+
| **Signal name**                          | **Start bit**                | **Bit length** | **Min**     | **Max**    | **Factor** | **Offset** | **Unit** | **Byteorder** |
+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+
| CAN0_SIG_MovMean_Power_10s               | 0                            | 32             | -2500000    | 4292467295 | 1.0        | -2500000   | W        | Intel         |
+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+
| CAN0_SIG_MovMean_Power_30s               | 32                           | 32             | -2500000    | 4292467295 | 1.0        | -2500000   | W        | Intel         |
+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+

+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+
| **Message: CAN0_MovMeanPower_2**         | **Message ID: 0x1D2**        | **DLC: 8**     |             |            |            |            |          |               |
+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+
| **Signal name**                          | **Start bit**                | **Bit length** | **Min**     | **Max**    | **Factor** | **Offset** | **Unit** | **Byteorder** |
+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+
| CAN0_SIG_MovMean_Power_60s               | 0                            | 32             | -2500000    | 4292467295 | 1.0        | -2500000   | W        | Intel         |
+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+
| CAN0_SIG_MovMean_Power_config            | 32                           | 32             | -2500000    | 4292467295 | 1.0        | -2500000   | W        | Intel         |
+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+

The messages ``CAN0_MovMeanPower_0``, ``CAN0_MovMeanPower_1`` and ``CAN0_MovMeanPower_2`` provide moving mean values over the different time frames 1s, 5s, 10s, 30s and 60s.
The signal ``CAN0_SIG_MovMean_Power_config`` can be configured to an arbitrary duration. These messages are currently not backed up with information and provided for 
forward-compatibility only.

----------------

+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+
| **Message: CAN0_MovMeanCurrent_0**       | **Message ID: 0x1E0**        | **DLC: 8**     |             |            |            |            |          |               |
+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+
| **Signal name**                          | **Start bit**                | **Bit length** | **Min**     | **Max**    | **Factor** | **Offset** | **Unit** | **Byteorder** |
+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+
| CAN0_SIG_MovMean_Current_1s              | 0                            | 32             | -2500000    | 4292467295 | 1.0        | -2500000   | mA       | Intel         |
+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+
| CAN0_SIG_MovMean_Current_5s              | 32                           | 32             | -2500000    | 4292467295 | 1.0        | -2500000   | mA       | Intel         |
+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+

+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+
| **Message: CAN0_MovMeanCurrent_1**       | **Message ID: 0x1E1**        | **DLC: 8**     |             |            |            |            |          |               |
+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+
| **Signal name**                          | **Start bit**                | **Bit length** | **Min**     | **Max**    | **Factor** | **Offset** | **Unit** | **Byteorder** |
+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+
| CAN0_SIG_MovMean_Current_10s             | 0                            | 32             | -2500000    | 4292467295 | 1.0        | -2500000   | mA       | Intel         |
+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+
| CAN0_SIG_MovMean_Current_30s             | 32                           | 32             | -2500000    | 4292467295 | 1.0        | -2500000   | mA       | Intel         |
+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+

+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+
| **Message: CAN0_MovMeanCurrent_2**       | **Message ID: 0x1E2**        | **DLC: 8**     |             |            |            |            |          |               |
+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+
| **Signal name**                          | **Start bit**                | **Bit length** | **Min**     | **Max**    | **Factor** | **Offset** | **Unit** | **Byteorder** |
+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+
| CAN0_SIG_MovMean_Current_60s             | 0                            | 32             | -2500000    | 4292467295 | 1.0        | -2500000   | mA       | Intel         |
+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+
| CAN0_SIG_MovMean_Current_config          | 32                           | 32             | -2500000    | 4292467295 | 1.0        | -2500000   | mA       | Intel         |
+------------------------------------------+------------------------------+----------------+-------------+------------+------------+------------+----------+---------------+

The messages ``CAN0_MovMeanCurrent_0``, ``CAN0_MovMeanCurrent_1`` and ``CAN0_MovMeanCurrent_2`` provide moving mean values over the different time frames 1s, 5s, 10s, 30s and 60s.
The signal ``CAN0_SIG_MovMean_Current_config`` can be configured to an arbitrary duration. These messages are currently not backed up with information and provided for 
forward-compatibility only.
