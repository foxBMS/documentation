...
Driver:
 - ``embedded-software\mcu-primary\src\application\com\com.h``
...
~~~~~~~~~~~~
UART:
 - ``embedded-software\mcu-common\src\module\uart\uart.c``
 - ``embedded-software\mcu-common\src\module\uart\uart.h``
