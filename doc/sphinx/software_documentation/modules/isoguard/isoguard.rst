...
Database
 - ``embedded-software\mcu-common\src\engine\database\database.h``
 - ``embedded-software\mcu-common\src\engine\config\database_cfg.h``
...
IO
 ...
 - ``embedded-software\mcu-common\src\module\config\io_cfg.h``

RTC
 - ``embedded-software\mcu-common\src\module\rtc\rtc.h``
 - ``embedded-software\mcu-common\src\module\config\rtc_cfg.h``
 
TIMER
 - ``embedded-software\mcu-primary\src\module\timer\timer.h``
 - ``embedded-software\mcu-primary\src\module\config\timer_cfg.h``
