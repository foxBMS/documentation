...
Driver:
 - ``embedded-software\mcu-primary\src\application\sox\sox.h``
 - ``embedded-software\mcu-primary\src\application\sox\sox.c``
 
Driver Configuration:
 - ``embedded-software\mcu-primary\src\application\config\sox_cfg.h``
 - ``embedded-software\mcu-primary\src\application\config\sox_cfg.c``

Dependencies
~~~~~~~~~~~~

Database:
 - ``embedded-software\mcu-common\src\engine\database\database.h`` (included implicitly by ``general.h``)
...
These values must ne adapted to the specific battery cells used.
